...
export default defineComponent({
  ...
  setup() {
    const projects: Project[] = [
      {
        ...
        desc: `Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit explicabo esse exercitationem natus in eligendi fugiat fugit beatae perspiciatis! Animi!
        `,
      ...
      },
      {
        ...
        desc: `Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, fugit hic? Mollitia repellat dolorum nulla.
        `,
    ...
    const next = () => {
      if (projects.length - 1 === index.value) {
        index.value = 0;
      } else {
        index.value++;
      }
